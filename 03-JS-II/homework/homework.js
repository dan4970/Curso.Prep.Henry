...
function esPrimo(numero) {
  ...
  // Pista: un número primo solo e y s divisible por sí mismopor 1
...
var tablaseis=array.map((item) => item*6)
return tablaseis;
}
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  var string = numero.toString();  // convierto al numero  en un stringpara despues medirlo
